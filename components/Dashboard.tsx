...
import { Wallet, TrendingUp, Zap, Droplets, ArrowUpRight } from 'lucide-react';
      ...
      <div className='px-4 py-6 space-y-8'>
        ...
        <section>
          ...
          {pools.length === 0 ? (
            ...
            <div className='space-y-3'>
              {pools.map((pool, i) => (
                <div key={pool.address || i}
                  className='bg-[#0f172a] border border-[#1e293b] hover:border-[#334155] rounded-2xl p-4 transition-colors'
                >
                  <div className='flex items-start justify-between mb-3'>
                    <div className='flex items-center gap-3'>
                      <div className='w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center font-bold text-sm text-blue-400'>
                        #{i + 1}
                      </div>
                      <div>
                  ...
                  <div className='grid grid-cols-3 gap-2 mb-3'>
                    ...
                    <div className='bg-[#1e293b]/50 rounded-lg p-2'>
                      ...
                      <p className='text-sm font-semibold text-green-400'>
                        {formatPercent(((pool.vol_24h * pool.fee_rate) / pool.tvl) * 100)}
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className='w-full py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold rounded-lg'
                  >
                    Enter Pool
                  </button>
                </div>
